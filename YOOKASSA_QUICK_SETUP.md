...
1. Создать фронтенд страницу с каталогом пакетов
2. Добавить отображение баланса токенов в шапке
3. Реализовать списание токенов при использовании AI
4. Настроить уведомления о низком балансе
